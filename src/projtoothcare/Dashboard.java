        ...
        jPanelUpdateLayout.setVerticalGroup(
            ...
            .addGroup(jPanelUpdateLayout.createSequentialGroup()
                ...
                .addGroup(jPanelUpdateLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTextFieldSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/toothcaredb", "root", "");
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                ...
                if (resultSet.next()) {
                    ...
                    jTextAreaInvoice.setText(jTextAreaInvoice.getText()+"   - Tooth Care Hospital -  \n");
                    ...
                    jTextAreaInvoice.setText(jTextAreaInvoice.getText()+"Whitening : "+whitening+"\n");
                    jTextAreaInvoice.setText(jTextAreaInvoice.getText()+"Cleaning : "+filling+"\n");
                    jTextAreaInvoice.setText(jTextAreaInvoice.getText()+"Filling : "+nerveFilling+"\n");
                    jTextAreaInvoice.setText(jTextAreaInvoice.getText()+"Root Canal : "+rootCanal+"\n");
                    jTextAreaInvoice.setText(jTextAreaInvoice.getText()+"\n***********************************\n\n");
